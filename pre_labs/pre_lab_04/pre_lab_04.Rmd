...
**Answer** Error: Can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>. One is a character column and one is a number column.
...
**Answer** Number is 44,032 loans, average is $53,836.46, and median is $20,000
...
**Answer** Number is 113,937 loans, average is $88,140.24, and median is $20,833.
...
**Answer** Rural number is 148, with an average of $44,328.87 and a median of $19,621. Urban number is 43,884, with an average of $53,868.53 and a median of $20,000.
...
**Answer** Rural number is 18,337 loans, with an average of $73,694.14 and a median of $20,833. Urban number is 95,600 loans, with an average of $90,911.14 and a median of $20,833.
