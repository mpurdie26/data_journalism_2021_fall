...
**Answer** The page starts with a "Industry Classification Overview" section that outlines structure, history, and the like with hyperlinks to other documents. Below this section is a description of each sector, a description of each division, time spans for their conversations, and more. 
...
**Answer** This displays the HTML code for the website, with tags like <div> that aren't used in R.
...
**Answer** It appears to be reading the HTML document and storing data under naics_industry, with a list of 2.
...
**Answer** It is showing us the general structure of the HTML, in which there are two main sections: head and body.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** I see the code for that specific table, all stored in a <table>. There are two parts to the table: <tr> and <tbody>.
...
**Answer** All six tables from the webpage have been exported into R as datasets.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** All six dataframes stored under naics_industry, along with their size. 
...
**Answer** This dataframe shows the time frames of the conversations and dates implemented and released.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The sector IDs and their descriptions.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Workforce statistics for just the mining sector.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** It appears to be reading the raw HTML document and storing data under employment_info.
...
**Answer** Only the specific table was read from the webpage using its id.
...
From here, we can use the html_table() function to transform it from messy html code to a proper dataframe.
...
**Answer** The table from the html has now been converted at an R data frame under employment_info.
...
**Answer** Only one piece of data remains.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Workforce statistics for the mining sector again.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Workforce statistics for the construction sector.
...
**Answer** All ten sectors are printed out.
```{r}
...
**Answer** Nothing below codeblock, but a new value has been made.
```{r}
...
**Answer** All ten sectors printed out once again.
```{r}
...
**Answer** Sector_list not found because that variable down not exist.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Once again, all ten sectors were printed out.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Sector_name and x don't align, as sector_name does not exist.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** 1 throuigh 10 printed out.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** A list of the sectors and their descriptions.
...
**Answer** The number of rows in naics_industry: 20.
...
**Answer** Prints all numbers from 1 to 20.
...
**Answer** Just one piece from the mining datafram.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** Once again, eachs sector and its description lol.
```{r}
# Define url of page we want to scrape
...
**Answer** A new column was made to make a url for each sector.
...
**Answer** A new column was made with each sectors xpath id.
...
**Answer** Public Administration was removed from the list since the website doesn't exist.
...
**Answer** Each row/sector was printed as its own dataframe.
...
**Answer** A new xpath id value has been made for each url/row.
```{r}
...
**Answer** 19 dataframes inside nested lists
...
**Answer** 19 clean dataframes with 1 row of data each.
...
**Answer** There are now 10 columns for each dataframe.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** Only the three columns we want remain in each dataframe, and the numbers qnd column names were cleaned.
...
**Answer** All dataframes were joined into one with 19 rows and 3 columns.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Once again, the workforce statistics for the mining secotr.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The workforce statistics for the agriculture sector.
...
**Answer** jun_2021_employees for the agriculture sector was changed to NA.
