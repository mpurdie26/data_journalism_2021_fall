...
**Answer** Shows how many people were vaccinated in each county on a particular day.
...
**Answer** There is an inconsistent amount of rows per county.
...
**Answer** A list of records in which the county wasn't reported.
...
**Answer** Not particularly, its very crazy.
...
**Answer** Peaked about a quarter way though and then steadily declined. A few days have no data.
...
**Answer** Shows the cummulative amount of vaccinations for each Maryland county for each day.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** I'm not quite sure, very ugly. I think the amount of cases per county per day? Not sure whats doing on at the bottom.
...
**Answer** Number of cummulative cases in each Maryland county.
