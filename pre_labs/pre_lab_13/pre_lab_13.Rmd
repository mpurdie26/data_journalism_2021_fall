...
**Answer** Shows who each state voted for and the percentage of businesses receiving PPP loans
```{r}
...
**Answer** Appears to be a scatterplot with slight correlation and a linear regression line to show the statisitcal average. 
```{r}
...
**Answer** R coefficient for two variables.
```{r}
reveal_data %>%
...
**Answer** Trump numbers seem to be higher
```{r}
reveal_data %>%
  group_by(vote_2016) %>%
  summarise(
