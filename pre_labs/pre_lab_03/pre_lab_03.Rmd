...
**Answer** Everytime I try doing this my entire computer shuts down so I don't know.
...
**Answer** $10 million is not suspiscious as that is the max loan amount, but $6 is definitely interesting. The chapter explains that this is consistent in all the columns, but it is unusual and could be cleared up with a call.
```{r}
