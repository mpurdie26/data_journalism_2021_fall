...
To use the API, you need to get [an API key from the Census Bureau](https://api.census.gov/data/key_signup.html). It takes a few minutes and you need to activate your key via email. Once you have your key, you need to set that for this session. Just FYI: Your key is your key. Do not share it.
...
**Answer** Somerset and Caroline counties, and Somerset has a large margin or error so maybe?
