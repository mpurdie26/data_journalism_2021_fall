...
#https://datawrapper.dwcdn.net/HiDda/1/ 
...
It is giving the number of loans per Maryland county, with some inaccuracies.
...
**Answer** Describe what the code below is doing and the output.
This cleans the inaccuracies in the Maryland counties dataset.
...
Combines both parts of the fips code to make a 5-digit code.
...
A combined dataset with county names, fips codes, and counts.
...
It is now just a map of Maryland.
...
**Answer** Describe the changes from the previous map
It shows county names and a clean count now,
...
#https://datawrapper.dwcdn.net/mXkcI/1/