...
**Answer** 195,865 rows and 63 columns
...
**Answer** From the ppp_maryland data, we are making a new dataframe of top 10 loans by county in Maryland. First, we are taking the data from ppp_maryland and grouping it by county name in order to get the total amount of loans per Maryland county. Then, we are sorting it from highest to lowest and only keeping the top 10 rows. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A messy bar graph showing the amount of loans for the top 10 Maryland counties. 
...
**Answer** The bars have been sorted from lowest to highest.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The bars are now horizontal
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background color is now white.
...
**Answer** The colors and fonts have changed.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** There is now a title and the axises are appropriately named.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The amount of loans approved for each day during the program.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A line graph depicting the amount of loans approved for each day during the program.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There is now a label for each month on the x-axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The labels for months are much cleaner and readable.
