...
**Answer** There are six different files for Hospitals.
...
**Answer** There are 33 variables, including hospital name, address, longitude, latitude, a point, and number of hospital beds.
...
**Answer** Only hospitals in Maryland remain.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This took the Maryland hospitals and grouped them by typed, then displayed the number of of hospitals for each type.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This narrows the Maryland hospital dataset to just those that are "General Acute Care."
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is a series of plots that kinda resemble Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This dataset lists every US county, with a multipolygon.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Only Maryland counties remain.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A county map of Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map of Maryland hospitals and counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** An updated Maryland hospital map with a colored scale.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This shows the 50 Maryland hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The total number of hospital beds per county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This dataset has the estimated population for each Maryland county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Has the population for each county and the multipolygon.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Each has a different format for county name.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This renamed the county names in the population datset and narrow down the amoun tof columns.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The datasets have been joined, showing the county name, hospital bed number, population, and multipolygon.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Counties with no hospitals have been cleaned
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A new column has been made to determine the number of beds per 100,000 people in each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Each county is filled with a color to represent the number of hospital beds per 100,000.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A different color is used to hjelp differentiate. 
...
**Answer** This adds even more colors on the scale.
