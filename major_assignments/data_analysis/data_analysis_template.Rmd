...
geocoded_data <- data1 %>%
  left_join(data2, by=c("id", "name", "date", "manner_of_death", "armed", "age", "gender", "race", "city", "state", "signs_of_mental_illness", "threat_level", "flee", "body_camera", "longitude", "latitude", "is_geocoding_exact", "census_tracts_geoid")) %>%
  left_join(data3, by=c("id", "name", "date", "manner_of_death", "armed", "age", "gender", "race", "city", "state", "signs_of_mental_illness", "threat_level", "flee", "body_camera", "longitude", "latitude", "is_geocoding_exact", "census_tracts_geoid"))
