...
counties <- counties %>%
  filter(STATEFP < "57")
#not working... we need to convert longitude and latitude to a spacial point
police_shootings %>%
  st_point(geometry = c("longitude", "latitude"))
...
In this notebook, we are researching five questions from these datasets.

### Question 1

* **Question text**: Are there geographical patterns 
