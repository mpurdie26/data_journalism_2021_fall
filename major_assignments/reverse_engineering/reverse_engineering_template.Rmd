...
## Data Library
Our data dictionary describes what each variable (column name) means in the cleaned_allegations dtaframe and gives the number of variable types for each variables. The only variables outlined in the dictionary are the ones used in order to reverse engineer the article.
