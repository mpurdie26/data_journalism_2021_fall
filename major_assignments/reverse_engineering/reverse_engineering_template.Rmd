...
#This doesn't work idk what Shreya means 
allegation_description <- read_excel("data/CCRB-Complaint-Data_202007271729/ccrb_data_layout_table.xlsx")

#Cleaned allegations data in Open Refine, loaded below
cleaned_allegations <- read_csv("data/CCRB-Complaint-Data_202007271729/cleaned_allegations_202007271729-csv-csv.csv")
