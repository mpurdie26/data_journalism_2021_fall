...
A2: The zipcode with the highest dollar amount in total loans is 25301. The business with the largest loan in the zipcode was "THE EYE AND EAR CLINIC OF CHARLESTON DBA CHARLESTON SURGICA" for $	1,520,007, and "NA" was forgiven. The loan amount is larger, since there is no forgiveness amount.
