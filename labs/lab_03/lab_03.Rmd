...
A3:
%>%
  filter(name == "DM Motors" | name == "Dutch Miller of Charleston" | name == "MFM Realty")
...
wv_ppp_loans %>%
  ...
  mutate(city = str_to_title(city)) %>%
  filter(city == "Cabell" | city == "Charleston" | city == "Huntington" | city == "Barboursville" | city == "Charlotte") %>%
  filter(business_type == "Partnership") 
